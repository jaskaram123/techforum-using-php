...
<div class="modal fade" id="login" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action= "login.php?d=index" method="post">
  <div class="mb-3">
...
<div class="modal fade" id="signup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <!-- the signup form -->
      <form action="logics/signup.php?d=index" method="post">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Username</label>
    <input type="text" name= 'username' class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <div class="container my-4">
        <h1 class="text-center" style="color: #198754">Browse categories</h1>
        <!-- cards container grid -->
        <div class="row">
<!-- card iteration starts here -->
<?php
  ...
  if ($number > 0) {
    while ($data = mysqli_fetch_assoc($result)) {
      ...
      <div class="card-body">
      <img src="https://source.unsplash.com/400x300/?coding,' . $data['category_name'] . '" class="card-img-top" alt="...">
      <h5 class="card-title">' . $data['category_name'] . '</h5>
      <p class="card-text">' . substr($data['category_desc'], 0 , 73) . '...</p>
      <a href="threads.php?categid=' . $data['category_id'] . '&d=threads" class="btn btn-primary" style="background-color:#198754">Visit thread</a>
      </div>
      </div>
      </div>';
    }
...
<!-- the above is the card sample -->
<!-- card iteration ends here -->
        </div>
